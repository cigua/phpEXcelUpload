...
//        }
        ...
        $row1=$result1->fetch();
        if($row1==0){
            $sql = "insert into db_qwechat_userregist(xingming,mobile,address,xingbie,cooperation,director,city,quxian,money,time,project,bumen,zhiwu,type) VALUES ('" . $strs[1] . "','" . $strs[2] . "','" . $strs[3] . "','" . $strs[4] . "','" . $strs[5] . "','" . $strs[6] . "','" . $strs[7] . "','" . $strs[8] . "','" . $strs[9] . "','" . $strs[10] . "','" . $strs[11] . "','" . $strs[12] . "','" . $strs[13] . "','" . $strs[14] . "')";
            $result = $db->_query($sql);
        }
        $b = "";
    }
